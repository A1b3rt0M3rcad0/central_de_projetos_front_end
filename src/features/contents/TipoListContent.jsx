...
export default function TipoListContent({
  ...
  const config = {
    ...
    showRefresh: true,
    showBulkActions: permissions.canEditTipo,
    showExport: true,
    loading: loading,
  };
  ...
  const actions = {
    bulk:
      permissions.canEditTipo
        ? [
            {
              label: "Exportar Selecionados",
              icon: <Eye className="w-4 h-4" />,
              onClick: (selectedItems) => {
                console.log("Exportar tipos:", selectedItems);
    ...
    export: {
      onClick: () => {
        console.log("Exportar todos os tipos");
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-200 p-6">
          <div className="flex items-center gap-4">
            <div className="flex-1 relative">
              ...
              <input
                type="text"
                placeholder="Buscar por nome do tipo... (pressione Enter)"
        ...
        <div className="overflow-x-auto">
          <DataTable
            ...
            columns={columns}
            config={config}
            onCreate={permissions.canCreateTipo ? onCreate : null}
